...
type CalculatorClient interface {
	Calculate(ctx context.Context, in *CalcInput, opts ...grpc.CallOption) (*CalcResult, error)
}
...
func (c *calculatorClient) Calculate(ctx context.Context, in *CalcInput, opts ...grpc.CallOption) (*CalcResult, error) {
...
type CalculatorServer interface {
	Calculate(context.Context, *CalcInput) (*CalcResult, error)
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *CalcInput) (*CalcResult, error) {
...
func _Calculator_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Calculate(ctx, req.(*CalcInput))
	}
